		...
		<table class="table table-striped" id="sportsarticleList">
			<thead>
				<tr>
					...
					<th class="nmtitle1">
						<?php echo JHtml::_('grid.sort', 'JGLOBAL_TITLE', 'a.nmtitle1', $listDirn, $listOrder); ?>
					</th>
					<th class="nmauthor">
						<?php echo JHtml::_('grid.sort', 'COM_SPORTSARTICLE_FIELD_NMAUTHOR_TITLE', 'a.nmauthor', $listDirn, $listOrder); ?>
					</th>
					<th class="nmauthor">
						<?php echo JHtml::_('grid.sort', 'COM_SPORTSARTICLE_FIELD_DTPUBLISHED_TITLE', 'a.dtpublished', $listDirn, $listOrder); ?>
					</th>
				</tr>
			</thead>
			<tbody>
